...
lib.ssMetadata = [
		{name:"PR_Legion_Pro_5_16IAX10_CM_GDN_300x600_atlas_1", frames: [[0,1806,50,50],[0,0,300,600],[0,602,300,600],[0,1204,300,600],[302,0,300,600],[302,602,300,600],[302,1204,300,600],[604,0,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_Pro_5_16IAX10_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegionPro516IAX10CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(201).to({_off:false},0).to({_off:true},49).wait(80));

	// Layer_4
	this.instance_3 = new lib.Frame4();
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(150).to({_off:false},0).to({_off:true},51).wait(129));
...
// library properties:
lib.properties = {
	id: '15DD72E2369CA841B342B1A2AE66F76B',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_Pro_5_16IAX10_CM_GDN_300x600_atlas_1.png", id:"PR_Legion_Pro_5_16IAX10_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['15DD72E2369CA841B342B1A2AE66F76B'] = {
